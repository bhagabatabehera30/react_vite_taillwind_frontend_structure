            ...
            >
                ...
                <div className="p-5 bg-white md:flex-1">
                   ...
                   <form action="#" className="flex flex-col space-y-5">
                        ...
                        <div className="flex flex-col space-y-1">
                            <div className="flex items-center justify-between">
                                <label htmlFor="password" className="text-sm font-semibold text-gray-500"></label>
                                <a href="/login" className="text-sm text-blue-600 hover:underline focus:text-blue-800">Log in?</a>
                            </div>
                        </div>
                        <div>
                            <button
